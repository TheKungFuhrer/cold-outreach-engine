...
const STEPS = [
  ...
  },
  {
    ...
    output: "data/classified_geolead/venues.csv",
    inputFlag: "--input",
    inputFrom: "prefilter",
    extraFlags: ["--output-dir", "data/classified_geolead"],
    description: "AI classification via Haiku Batch API (GeoLead batch)",
  },
  {
    name: "escalate",
    cmd: "python",
    script: "2-enrichment/escalate_sonnet.py",
    output: "data/verified_geolead/venues.csv",
    optional: true,
    extraFlags: ["--input", "data/classified_geolead/ambiguous.csv", "--output-dir", "data/verified_geolead"],
    description: "Sonnet escalation for ambiguous leads (GeoLead batch)",
  },
  {
    name: "phones",
    cmd: "python",
