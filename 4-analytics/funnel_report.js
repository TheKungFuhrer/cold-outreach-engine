...
const STAGES = [
  ...
  { name: "Classified non-venues", path: "data/classified/non_venues.csv" },
  { name: "Classified ambiguous", path: "data/classified/ambiguous.csv" },
  { name: "Sonnet → venues", path: "data/verified/venues.csv" },
  { name: "Sonnet → non-venues", path: "data/verified/non_venues.csv" },
  { name: "Phone: mobile", path: "data/phone_validated/mobile.csv" },
  { name: "Phone: landline", path: "data/phone_validated/landline.csv" },
  { name: "Phone: invalid", path: "data/phone_validated/invalid.csv" },
  { name: "Phone: no phone", path: "data/phone_validated/no_phone.csv" },
];
